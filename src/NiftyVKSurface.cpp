...
Surface::Surface(Instance* instance, Device* device, GLFWwindow* window):
	...
	descriptor_set_layout(device, instance),
...
void Surface::CreatePipeline()
{
	...
	descriptor_set_layout.Init(bindings);
	...
	pipeline_layout.Init(descriptor_set_layout.vk_descriptor_set_layout);
...
void Surface::VertexInputStage::Init()
{
...
void Surface::InputAssemblyStage::Init()
{
...
void Surface::ViewportStage::Init(vk::Extent2D extent)
{
	viewport.setX(0.0f)
		.setY(0.0f)
...
void Surface::RasterizationStage::Init()
{
...
void Surface::MultisampleStage::Init()
{
...
void Surface::ColorBlendStage::Init()
{
...
void Surface::DescriptorSetLayout::Init(std::vector<Binding> bindings)
{
...
void Surface::DescriptorSetLayout::Cleanup()
{
...
void Surface::DescriptorPool::Init(std::vector<Binding> bindings, uint32_t count)
{
...
void Surface::DescriptorPool::Cleanup()
{
...
void Surface::PipelineLayout::Init(vk::DescriptorSetLayout descriptor_set_layout)
{
...
void Surface::PipelineLayout::Cleanup()
{
...
void Surface::RenderPass::Init(vk::Format format)
{
...
void Surface::RenderPass::Cleanup()
{
...
void Surface::Frame::AllocateDescriptorResources()
{
	...
	vk::DescriptorSetAllocateInfo alloc_info = vk::DescriptorSetAllocateInfo()
												   ...
												   .setPSetLayouts(&surface->descriptor_set_layout.vk_descriptor_set_layout);
	try
	{
